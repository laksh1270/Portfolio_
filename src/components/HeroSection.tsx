    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-between p-8 md:p-12 relative min-h-[420px]">
          ...
          {/* Pills — positioned above where the arch will be */}
          <motion.div
        ...
        {/* ======= ARCH — absolutely on CARD so bottom:0 = card border ======= */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          {/* Outer arch — very large, left foot goes off-screen */}
          <div
            style={{
              position: "absolute",
              bottom: 0,
          ...
          />
          {/* Inner arch — smaller, sits in the right portion of outer arch */}
          <div
            style={{
              position: "absolute",
              bottom: 0,
